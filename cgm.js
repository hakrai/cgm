(function () {
  ...
  /* ================= ANCHORED POPUPS (rename / new group / chat menu) ================= */
  ...
  function buildGroupEl(group) {
    ...
    div.querySelector('[data-act="delete"]').addEventListener('click', () => { deleteGroup(group.id); });
    return div;
  }
  ...
  function openSettingsModal() {
    ...
    openCenteredModal({
      ...
      bodyBuilder: (body) => {
        ...
        body.querySelector('#cgm_custom_color').addEventListener('input', (e) => { DATA.settings.accent = e.target.value; saveData(); applySettingsToDOM(); });
  ...
  function injectStyles() {
    ...
    .cgm_seg_btn{ flex:1; padding:7px; background:var(--cgm-bg); border:none; color:var(--cgm-fg); cursor:pointer; font-size:13px; }
